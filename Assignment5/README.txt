...
│   ├── Assignment_5.1.js            # The assignment script. EDIT/ADD YOUR CODE HERE. The main differences between the skeleton code between Assignment 4 and 5 is the vertex and fragment shaders
...
Step 3: Open a web browser (e.g Chrome) and type: http://localhost/cosc6344/
        Add your code to Assignment_5.1.js. 
