...
│   ├── Assignment_3.1.js            # The assignment script. EDIT/ADD YOUR CODE HERE 
|   ├── plyLoader.js                 # The library to load PLY files. Don't edit this one
|   ├── bootstrap-input-spinner.js   # The library to create input spinners in bootstrap. Please see sample code at https://github.com/shaack/bootstrap-input-spinner
...
Step 3: Open a web browser (e.g Chrome) and type: http://localhost/cosc6344/
        Add your code to Assignment_3.1.js. We provide a sample implementation of load_data_on_uniformGrids
