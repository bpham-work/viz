...
│   ├── Assignment_6.1.js            # The assignment script. EDIT/ADD YOUR CODE HERE. The main differences between the skeleton code between Assignment 4 and 5 is the vertex and fragment shaders
|   ├── plyLoader.js                 # The library to load PLY files. EDIT/ADD YOUR CODE TO LOAD PLY FILES
...
Step 3: Open a web browser (e.g Chrome) and type: http://localhost/cosc6344/
        Add your code to Assignment_6.1.js. 
